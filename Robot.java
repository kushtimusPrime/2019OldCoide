...
public class Robot extends TimedRobot {
	...
	private ContourGripPipeline gripPipeline;
	...
	public void robotInit() {
		 ...
		 */
		cameraServerZero = CameraServer.getInstance();
		cameraZero = cameraServerZero.startAutomaticCapture(0);
		cameraOne=CameraServer.getInstance().startAutomaticCapture(1);
		...
		Mat source=new Mat();
		visionThread = new VisionThread(cameraZero, new ContourGripPipeline(), new VisionRunner.Listener<VisionPipeline>() {
...
//				cvOutputZero.putFrame(output);
        ...
        if(xEntry.getValue().isDouble()) {
        	SmartDashboard.putNumber(xEntry.getName(), xEntry.getValue().getDouble());
        }
