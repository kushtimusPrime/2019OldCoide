...
public class RobotMap {
    ...
    public static void init() {
    	...
    	//looking at robot from front, so bottom is closer to the front
    	//Bixel Room Blue: Channel 0
    	
        driveSubsystemBottomLeft = new PWMVictorSPX(0);
        LiveWindow.addActuator("DriveSubsystem", "BottomLeft", (PWMVictorSPX) driveSubsystemBottomLeft);
        driveSubsystemBottomLeft.setInverted(true);
        driveSubsystemTopLeft = new PWMVictorSPX(2);
        LiveWindow.addActuator("DriveSubsystem", "TopLeft", (PWMVictorSPX) driveSubsystemTopLeft);
        driveSubsystemTopLeft.setInverted(true);
        ...
        driveSubsystemBottomRight = new PWMVictorSPX(3);
        LiveWindow.addActuator("DriveSubsystem", "BottomRight", (PWMVictorSPX) driveSubsystemBottomRight);
        driveSubsystemBottomRight.setInverted(true);
        driveSubsystemTopRight = new PWMTalonSRX(1);
        LiveWindow.addActuator("DriveSubsystem", "TopRight", (PWMTalonSRX) driveSubsystemTopRight);
        driveSubsystemTopRight.setInverted(true);
