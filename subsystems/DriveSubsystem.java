...
public class DriveSubsystem extends Subsystem {
    ...
    public void takeJoystickInput(Joystick joystick) { // On keemstar, all the X and Y values are flipped and the arcadeDrive() has a *-1 tacked on. Delete this when working on Ernest.
    	double sensitivity=((joystick.getThrottle()*-1)/5)+0.8;
    	differentialDrive1.arcadeDrive(joystick.getY()*sensitivity, joystick.getX()*sensitivity*-1);
    }
    
    public void takeXJoystickAxisOnly(Joystick joystick) {
    	double sensitivity=((joystick.getThrottle()*-1)/6.6667)+0.7;
